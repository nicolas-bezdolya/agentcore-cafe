"""
AgentCore Café — Level 08: House Rules ☕📜
Cedar policies enforce identity-based and input-based rules on the Gateway.
"""
...
- Some Gateway tools may not be available to you depending on the user's role (enforced by Cedar policies).
- If a tool like check_stock or place_real_order is NOT in your available tools, do NOT improvise or pretend you performed the action.
- Instead, politely tell the user you don't have permission for that action with their current role.
